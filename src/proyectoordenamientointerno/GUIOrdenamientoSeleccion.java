 ...
 */
public class GUIOrdenamientoSeleccion extends javax.swing.JFrame {

    /**
     * Creates new form GUIOrdenamientoSeleccion
     */
    public GUIOrdenamientoSeleccion() {
        initComponents();
        ...
        int tam = metAOrdenar.getGuardarOrdenamientos().size();
            ...
            jTableSeleccion.setModel(new javax.swing.table.DefaultTableModel(
                matriz,
                new String [] {
    ...
    private void initComponents() {
        ...
        jTableSeleccion = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("Ordenamiento por Seleccion");
        ...
        jScrollPane1.setViewportView(jTableSeleccion);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIOrdenamientoSeleccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIOrdenamientoSeleccion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableSeleccion;
